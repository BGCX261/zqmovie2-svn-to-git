...
<html>
	...
	<body>
		<html:form action="/editMovie" enctype="multipart/form-data">
			<table border="0" width="100%">
				<tr>
					<td align="right">ID:</td>
					<td align="left">${sessionScope.movieActionForm.movie.id}</td>
				</tr>			
				<tr>
				...
				<FCK:editor id="intro" basePath="${pageScope.path}/fckeditor/" width ="600" height ="400" 
             				...
             				<bean:write name="movieActionForm" property="movie.intro" filter="false"/>    
				</FCK:editor>
					</td>
				</tr>				
				<tr align="center">
