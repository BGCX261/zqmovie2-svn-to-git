...
public class NavigationBar {
	...
	private static String barFirst="<a href='#pageUrl#?bid=#bid#&&pag=1'>[首页]</a>";
	private static String barPrevious="<a href='#pageUrl#?bid=#bid#&&pag=#pagPrevious#'>[上一页]</a>";
	private static String barNext="<a href='#pageUrl#?bid=#bid#&&pag=#pagNext#'>[下一页]</a>";
	private static String barLast="<a href='#pageUrl#?bid=#bid#&&pag=#pagLast#'>[尾页]</a>";
	...
	public void init(int bid,int pageCurrent,String pageUrl,int recordPerPage,int recordCount){
